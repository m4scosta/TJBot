Este é um bot para te ajudar a estudar para o TJ-SP 2017, nele você encontrará diversas questões de provas passadas.
Comandos disponíveis:
  - /help: exibe ajuda
  - /perguntar: uma nova pergunta é enviada para você
